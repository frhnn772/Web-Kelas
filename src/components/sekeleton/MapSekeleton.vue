  ...
  <div class="lg:ml-24 ring-2 ring-red-500 bg-gray-400 rounded-xl">
    <div class="animate-pulse">
      ...
      <div class="h-32 w-52 mx-3 my-3 bg-gray-300 rounded-sm absolute z-50 shadow-md">
        ...
        <div class="h-3 w-24 mx-3 my-3 bg-gray-400"></div>
      </div>
      <div class="h-9 w-9 mx-3 my-3 bg-gray-300 rounded-sm absolute bottom-0 left-0 z-50 shadow-md"></div>
      <div class="h-16 w-9 mx-3 my-3 bg-gray-300 rounded-sm absolute bottom-2 right-0 z-50 shadow-md"></div>
      <div class="w-full flex justify-center items-center">
        <svg class="w-11 -mt-8 h-auto text-gray-200"
          fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
